...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILw7/l;)V
    .locals 3
    ...
    invoke-interface {p4, p1}, Lw7/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p1, p2, v2, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILw7/l;)V
...
.method public static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILw7/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILw7/l;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lw7/q;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, v0, v4, v5}, Lw7/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    invoke-static {v8, v5}, Lkotlin/jvm/internal/g;->e(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v12, v7}, Lkotlin/jvm/internal/g;->e(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v2, v7}, Lm7/n;->R(Ljava/util/Collection;[Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-static {v2}, La6/b;->f(Lkotlin/collections/builders/SetBuilder;)Lkotlin/collections/builders/SetBuilder;
    ...
    :cond_6
    invoke-static {v4}, Lcom/google/android/gms/common/internal/d0;->k(Lkotlin/collections/builders/ListBuilder;)Lkotlin/collections/builders/ListBuilder;
    ...
    invoke-direct {v11, v8, v7, v4}, Landroidx/room/AmbiguousColumnResolver$resolve$1$1;-><init>([Ljava/lang/String;Ljava/util/List;I)V

    invoke-direct {v10, v0, v8, v11}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lw7/q;)V
    ...
    invoke-virtual {v0, v11}, Lkotlin/collections/builders/ListBuilder;->listIterator(I)Ljava/util/ListIterator;
    ...
    check-cast v15, Lkotlin/collections/builders/ListBuilder$a;

    invoke-virtual {v15}, Lkotlin/collections/builders/ListBuilder$a;->hasNext()Z

    move-result v16

    if-eqz v16, :cond_9

    invoke-virtual {v15}, Lkotlin/collections/builders/ListBuilder$a;->next()Ljava/lang/Object;
    ...
    invoke-static {v13, v5}, Lkotlin/jvm/internal/g;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v14, v5}, Lkotlin/collections/builders/ListBuilder;->add(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-static {v14}, Lcom/google/android/gms/common/internal/d0;->k(Lkotlin/collections/builders/ListBuilder;)Lkotlin/collections/builders/ListBuilder;
    ...
    invoke-static {v0, v13, v1}, Landroid/support/v4/media/e;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v15, v7, v4}, Landroidx/room/AmbiguousColumnResolver$resolve$1$2;-><init>(Ljava/util/List;I)V

    const/16 v16, 0x6

    const/16 v17, 0x0

    invoke-static/range {v11 .. v17}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILw7/l;ILjava/lang/Object;)V
    ...
    invoke-direct {v10, v0}, Landroidx/room/AmbiguousColumnResolver$resolve$4;-><init>(Lkotlin/jvm/internal/Ref$ObjectRef;)V

    const/4 v11, 0x6

    const/4 v12, 0x0

    invoke-static/range {v6 .. v12}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILw7/l;ILjava/lang/Object;)V
    ...
    invoke-static {v2}, Lkotlin/collections/a;->n0(Ljava/util/Collection;)[I
