...
.field private final controlFrameBuffer:Lx8/d;
...
.field private final messageFrameBuffer:Lx8/d;
...
# direct methods
.method public constructor <init>(ZLx8/f;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
    .locals 1
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lx8/f;
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lx8/d;

    new-instance p2, Lx8/d;

    invoke-direct {p2}, Lx8/d;-><init>()V

    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lx8/d;
    ...
    :goto_1
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lx8/d$a;
...
.method private final readControlFrame()V
    ...
    iget-object v4, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lx8/f;

    iget-object v5, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lx8/d;

    invoke-interface {v4, v5, v0, v1}, Lx8/f;->b0(Lx8/d;J)V

    iget-boolean v0, p0, Lokhttp3/internal/ws/WebSocketReader;->isClient:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lx8/d;

    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lx8/d$a;

    invoke-static {v1}, Lkotlin/jvm/internal/g;->c(Ljava/lang/Object;)V

    invoke-virtual {v0, v1}, Lx8/d;->w(Lx8/d$a;)Lx8/d$a;

    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lx8/d$a;

    invoke-virtual {v0, v2, v3}, Lx8/d$a;->e(J)I
    ...
    invoke-virtual {v0, v1, v4}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lx8/d$a;[B)V

    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lx8/d$a;

    invoke-virtual {v0}, Lx8/d$a;->close()V
    ...
    invoke-static {v1, v2}, Lkotlin/jvm/internal/g;->l(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lx8/d;
    ...
    invoke-virtual {v1}, Lx8/d;->K()Ljava/lang/String;
...
.method private final readHeader()V
    ...
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lx8/f;
    ...
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lx8/f;

    invoke-interface {v2}, Lx8/f0;->timeout()Lx8/g0;

    move-result-object v2

    invoke-virtual {v2}, Lx8/g0;->clearTimeout()Lx8/g0;

    :try_start_0
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lx8/f;

    invoke-interface {v2}, Lx8/f;->readByte()B
    ...
    invoke-interface {v4}, Lx8/f0;->timeout()Lx8/g0;

    move-result-object v4

    sget-object v5, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v4, v0, v1, v5}, Lx8/g0;->timeout(JLjava/util/concurrent/TimeUnit;)Lx8/g0;
    ...
    invoke-interface {v0}, Lx8/f;->readByte()B
    ...
    invoke-interface {v0}, Lx8/f;->readShort()S
    ...
    invoke-interface {v0}, Lx8/f;->readLong()J
    ...
    invoke-interface {v0, v1}, Lx8/f;->readFully([B)V
    ...
    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lx8/f;

    invoke-interface {v3}, Lx8/f0;->timeout()Lx8/g0;

    move-result-object v3

    sget-object v4, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, v0, v1, v4}, Lx8/g0;->timeout(JLjava/util/concurrent/TimeUnit;)Lx8/g0;
...
.method private final readMessage()V
    ...
    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lx8/d;

    invoke-interface {v2, v3, v0, v1}, Lx8/f;->b0(Lx8/d;J)V

    iget-boolean v0, p0, Lokhttp3/internal/ws/WebSocketReader;->isClient:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lx8/d;
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:Lx8/d;
    ...
    invoke-virtual {v0, v1, v2}, Lx8/d$a;->e(J)I
    ...
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lx8/d$a;[B)V
...
.method private final readMessageFrame()V
    ...
    invoke-virtual {v2, v3}, Lokhttp3/internal/ws/MessageInflater;->inflate(Lx8/d;)V
