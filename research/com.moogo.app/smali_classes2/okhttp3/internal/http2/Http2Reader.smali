...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$Companion;-><init>(Lkotlin/jvm/internal/d;)V
...
.method public constructor <init>(Lx8/f;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lx8/f;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Reader;->client:Z

    new-instance v2, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lx8/f;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lx8/f0;IIILkotlin/jvm/internal/d;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lx8/f;

    invoke-interface {v1}, Lx8/f;->readByte()B
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lx8/f;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILx8/f;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lx8/f;
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lx8/f;

    invoke-interface {p4}, Lx8/f;->readInt()I

    move-result p4

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lx8/f;

    invoke-interface {v0}, Lx8/f;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, Lx8/f;->g(J)Lokio/ByteString;
    ...
    invoke-static {p3, p2}, Lkotlin/jvm/internal/g;->l(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lx8/f;

    invoke-interface {p2}, Lx8/f;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 12
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lx8/f;

    invoke-interface {v3}, Lx8/f;->readByte()B
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 4
    invoke-static {p3, p2, p4}, Landroid/support/v4/media/b;->c(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private final readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, Lx8/f;->readInt()I
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Lb8/i;->A(II)Lb8/h;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lb8/i;->z(Lb8/h;I)Lb8/f;

    move-result-object p2

    iget v1, p2, Lb8/f;->a:I

    iget v2, p2, Lb8/f;->b:I

    iget p2, p2, Lb8/f;->c:I
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lx8/f;

    invoke-interface {v4}, Lx8/f;->readShort()S
    ...
    iget-object v5, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lx8/f;

    invoke-interface {v5}, Lx8/f;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lx8/f;)I
    ...
    invoke-interface {p1, v0, v1}, Lx8/f;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v1, v2}, Lx8/f;->g(J)Lokio/ByteString;
    ...
    invoke-static {v3, v2}, Lkotlin/jvm/internal/g;->l(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
