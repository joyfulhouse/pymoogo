...
.field private final hpackBuffer:Lx8/d;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Writer$Companion;-><init>(Lkotlin/jvm/internal/d;)V
...
.method public constructor <init>(Lx8/e;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lx8/e;
    ...
    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lx8/d;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLx8/d;ILkotlin/jvm/internal/d;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lx8/e;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lx8/d;
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lx8/e;
...
.method public final declared-synchronized connectionPreface()V
    ...
    invoke-static {v2, v1}, Lkotlin/jvm/internal/g;->l(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v0, v1}, Lx8/e;->Q(Lokio/ByteString;)Lx8/e;
...
.method public final declared-synchronized data(ZILx8/d;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILx8/d;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILx8/d;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, p3, v0, v1}, Lx8/d0;->write(Lx8/d;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lx8/e;I)V

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lx8/e;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Lx8/e;->writeByte(I)Lx8/e;
    ...
    invoke-interface {p2, p1}, Lx8/e;->writeInt(I)Lx8/e;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lx8/e;->writeInt(I)Lx8/e;
    ...
    invoke-interface {p1, p2}, Lx8/e;->writeInt(I)Lx8/e;
    ...
    invoke-interface {p1, p3}, Lx8/e;->write([B)Lx8/e;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lx8/d;

    iget-wide v0, p3, Lx8/d;->b:J
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lx8/d;

    invoke-interface {p1, v4, v2, v3}, Lx8/d0;->write(Lx8/d;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lx8/e;->writeInt(I)Lx8/e;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lx8/e;

    const v5, 0x7fffffff

    and-int/2addr p2, v5

    invoke-interface {v2, p2}, Lx8/e;->writeInt(I)Lx8/e;

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lx8/e;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lx8/d;

    invoke-interface {p2, v2, v3, v4}, Lx8/d0;->write(Lx8/d;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lx8/e;

    invoke-interface {v4, v3}, Lx8/e;->writeShort(I)Lx8/e;

    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lx8/e;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v2

    invoke-interface {v3, v2}, Lx8/e;->writeInt(I)Lx8/e;
