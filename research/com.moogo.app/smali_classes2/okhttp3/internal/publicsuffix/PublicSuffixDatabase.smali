...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/publicsuffix/PublicSuffixDatabase$Companion;-><init>(Lkotlin/jvm/internal/d;)V
...
.method private final findMatchingRule(Ljava/util/List;)Ljava/util/List;
    ...
    :cond_4
    invoke-static {v5}, Lkotlin/jvm/internal/g;->m(Ljava/lang/String;)V
    ...
    invoke-static {v5, p1}, Lkotlin/jvm/internal/g;->l(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v2}, Lkotlin/text/b;->a0(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    invoke-static {v8, v2}, Lkotlin/text/b;->a0(Ljava/lang/CharSequence;[C)Ljava/util/List;
...
.method private final readTheList()V
    ...
    invoke-static {v0}, Lx8/t;->f(Ljava/io/InputStream;)Lx8/p;

    move-result-object v0

    invoke-direct {v1, v0}, Lx8/n;-><init>(Lx8/f0;)V
    ...
    :try_start_0
    invoke-virtual {v0}, Lx8/a0;->readInt()I

    move-result v1

    int-to-long v1, v1

    invoke-virtual {v0, v1, v2}, Lx8/a0;->Z(J)V

    iget-object v3, v0, Lx8/a0;->b:Lx8/d;

    invoke-virtual {v3, v1, v2}, Lx8/d;->y(J)[B
    ...
    invoke-virtual {v0, v2, v3}, Lx8/a0;->Z(J)V

    iget-object v4, v0, Lx8/a0;->b:Lx8/d;

    invoke-virtual {v4, v2, v3}, Lx8/d;->y(J)[B
    ...
    invoke-static {v0, v3}, La6/b;->o(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private final splitDomain(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p1, v1}, Lkotlin/text/b;->a0(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    :goto_0
    invoke-static {v1, v2}, Lkotlin/collections/a;->k0(Ljava/lang/Iterable;I)Ljava/util/List;
...
.method public final getEffectiveTldPlusOne(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v2, p1}, Lm7/p;-><init>(Ljava/lang/Iterable;)V
    ...
    :cond_3
    instance-of p1, v2, Ld8/c;

    if-eqz p1, :cond_4

    check-cast v2, Ld8/c;

    invoke-interface {v2, v0}, Ld8/c;->a(I)Ld8/g;
    ...
    invoke-direct {p1, v2, v0}, Ld8/b;-><init>(Ld8/g;I)V
    ...
    invoke-interface {v2}, Ld8/g;->iterator()Ljava/util/Iterator;
    ...
    :cond_5
    invoke-static {p1, v2, v4}, Le1/c;->g(Ljava/lang/StringBuilder;Ljava/lang/Object;Lw7/l;)V
    ...
    invoke-static {p1, v0, v1}, Landroid/support/v4/media/b;->c(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
