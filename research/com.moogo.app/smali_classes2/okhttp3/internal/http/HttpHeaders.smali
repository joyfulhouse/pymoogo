...
.method public static final parseChallenges(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p1, v4}, Le8/f;->A(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v4, v2}, Lx8/d;->l0(Ljava/lang/String;)V

    :try_start_0
    invoke-static {v4, v0}, Lokhttp3/internal/http/HttpHeaders;->readChallengeHeader(Lx8/d;Ljava/util/List;)V
    :try_end_0
...
.method public static final promisesBody(Lokhttp3/Response;)Z
    ...
    invoke-static {v0, p0}, Le8/f;->A(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private static final readChallengeHeader(Lx8/d;Ljava/util/List;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->skipCommasAndWhitespace(Lx8/d;)Z

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readToken(Lx8/d;)Ljava/lang/String;
    ...
    invoke-static {p0, v4}, Lokhttp3/internal/Util;->skipAll(Lx8/d;B)I
    ...
    :goto_5
    invoke-static {v4, v3}, Lkotlin/jvm/internal/g;->l(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v5}, Lokhttp3/internal/http/HttpHeaders;->startsWith(Lx8/d;B)Z

    move-result v5

    if-eqz v5, :cond_11

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readQuotedString(Lx8/d;)Ljava/lang/String;
...
.method private static final readQuotedString(Lx8/d;)Ljava/lang/String;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/EOFException;
    ...
    invoke-virtual {p0, v2}, Lx8/d;->s(Lokio/ByteString;)J
    ...
    invoke-virtual {v0, p0, v2, v3}, Lx8/d;->write(Lx8/d;J)V
    ...
    invoke-virtual {v0, p0, v8, v9}, Lx8/d;->write(Lx8/d;J)V
...
.method private static final readToken(Lx8/d;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lokio/ByteString;

    invoke-virtual {p0, v0}, Lx8/d;->s(Lokio/ByteString;)J
    ...
    invoke-virtual {p0, v0, v1}, Lx8/d;->M(J)Ljava/lang/String;
...
.method private static final skipCommasAndWhitespace(Lx8/d;)Z
    .locals 5
...
.method private static final startsWith(Lx8/d;B)Z
    .locals 2
