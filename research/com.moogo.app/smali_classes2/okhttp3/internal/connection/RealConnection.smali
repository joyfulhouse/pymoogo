...
.field private sink:Lx8/e;

.field private socket:Ljava/net/Socket;

.field private source:Lx8/f;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/connection/RealConnection$Companion;-><init>(Lkotlin/jvm/internal/d;)V
...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    :try_start_1
    invoke-static {v1}, Lx8/t;->g(Ljava/net/Socket;)Lx8/f0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lx8/f;

    invoke-static {v1}, Lx8/t;->d(Ljava/net/Socket;)Lx8/d0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lx8/e;
    :try_end_1
    ...
    invoke-static {p3, p4}, Lkotlin/jvm/internal/g;->l(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-static {p1}, Lkotlin/text/a;->x(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, v5, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Lw7/a;)V
    ...
    invoke-virtual {v0, v1, v2}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lw7/a;)V
    ...
    invoke-static {v3}, Lx8/t;->g(Ljava/net/Socket;)Lx8/f0;
    ...
    invoke-static {v3}, Lx8/t;->d(Ljava/net/Socket;)Lx8/d0;
...
.method private final connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lx8/e;

    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lx8/f;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lx8/f;

    invoke-static {v0}, Lkotlin/jvm/internal/g;->c(Ljava/lang/Object;)V

    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lx8/e;
    ...
    invoke-direct {v2, v3, p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lx8/f;Lx8/e;)V
    ...
    invoke-virtual {v4, v5, v6, v7}, Lx8/g0;->timeout(JLjava/util/concurrent/TimeUnit;)Lx8/g0;

    invoke-interface {v1}, Lx8/d0;->timeout()Lx8/g0;
    ...
    invoke-static {v1, p3}, Le8/f;->A(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p2, p3}, Lkotlin/jvm/internal/g;->l(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lx8/d;->m()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-interface {v1}, Lx8/e;->a()Lx8/d;
...
.method private final startHttp2(I)V
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lx8/f;

    invoke-static {v1}, Lkotlin/jvm/internal/g;->c(Ljava/lang/Object;)V

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lx8/e;
    ...
    invoke-virtual {v4, v0, v5, v1, v2}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lx8/f;Lx8/e;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {v3, v0, v4}, Landroid/support/v4/media/e;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->source:Lx8/f;

    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lx8/e;
...
.method public final isHealthy(Z)Z
    ...
    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->source:Lx8/f;
    ...
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->isHealthy(Ljava/net/Socket;Lx8/f;)Z
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    invoke-interface {v1}, Lx8/f0;->timeout()Lx8/g0;
    ...
    invoke-virtual {v0, v3, v4, v5}, Lx8/g0;->timeout(JLjava/util/concurrent/TimeUnit;)Lx8/g0;

    invoke-interface {v2}, Lx8/d0;->timeout()Lx8/g0;
    ...
    invoke-direct {v0, p1, p0, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lx8/f;Lx8/e;)V
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct {v0, v1, v2, p1}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Lx8/f;Lx8/e;Lokhttp3/internal/connection/Exchange;)V
