...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/MultipartBody$Companion;-><init>(Lkotlin/jvm/internal/d;)V
...
.method private final writeOrCountBytes(Lx8/e;Z)J
    .locals 13
    ...
    invoke-interface {p1, v8}, Lx8/e;->write([B)Lx8/e;

    iget-object v8, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/ByteString;

    invoke-interface {p1, v8}, Lx8/e;->Q(Lokio/ByteString;)Lx8/e;
    ...
    invoke-interface {p1, v11}, Lx8/e;->C(Ljava/lang/String;)Lx8/e;

    move-result-object v11

    sget-object v12, Lokhttp3/MultipartBody;->COLONSPACE:[B

    invoke-interface {v11, v12}, Lx8/e;->write([B)Lx8/e;
    ...
    invoke-interface {v11, v9}, Lx8/e;->C(Ljava/lang/String;)Lx8/e;

    move-result-object v9

    sget-object v11, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v9, v11}, Lx8/e;->write([B)Lx8/e;
    ...
    invoke-interface {p1, v8}, Lx8/e;->C(Ljava/lang/String;)Lx8/e;
    ...
    invoke-interface {v8, v7}, Lx8/e;->C(Ljava/lang/String;)Lx8/e;

    move-result-object v7

    sget-object v8, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v7, v8}, Lx8/e;->write([B)Lx8/e;
    ...
    invoke-interface {p1, v9}, Lx8/e;->C(Ljava/lang/String;)Lx8/e;

    move-result-object v9

    invoke-interface {v9, v7, v8}, Lx8/e;->c0(J)Lx8/e;

    move-result-object v9

    sget-object v10, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v9, v10}, Lx8/e;->write([B)Lx8/e;
    ...
    invoke-interface {p1, v9}, Lx8/e;->write([B)Lx8/e;
    ...
    :cond_5
    invoke-virtual {v5, p1}, Lokhttp3/RequestBody;->writeTo(Lx8/e;)V
    ...
    invoke-interface {p1, v1}, Lx8/e;->write([B)Lx8/e;

    iget-object v2, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/ByteString;

    invoke-interface {p1, v2}, Lx8/e;->Q(Lokio/ByteString;)Lx8/e;
...
.method public contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lx8/e;Z)J
...
.method public writeTo(Lx8/e;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lx8/e;Z)J
