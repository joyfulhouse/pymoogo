...
# direct methods
.method public static final I(Ljava/lang/CharSequence;Ljava/lang/String;Z)Z
    .locals 2
    ...
    invoke-static {p0, p1, v1, p2, v0}, Lkotlin/text/b;->O(Ljava/lang/CharSequence;Ljava/lang/String;IZI)I
...
.method public static J(Ljava/lang/CharSequence;C)Z
    ...
    invoke-static {p0, p1, v1, v1, v0}, Lkotlin/text/b;->N(Ljava/lang/CharSequence;CIZI)I
...
.method public static final L(ILjava/lang/CharSequence;Ljava/lang/String;Z)I
    ...
    invoke-static/range {v0 .. v5}, Lkotlin/text/b;->M(Ljava/lang/CharSequence;Ljava/lang/CharSequence;IIZZ)I
...
.method public static final M(Ljava/lang/CharSequence;Ljava/lang/CharSequence;IIZZ)I
    ...
    :cond_1
    invoke-direct {p5, p2, p3}, Lb8/h;-><init>(II)V

    goto :goto_0

    :cond_2
    invoke-static {p0}, Lkotlin/text/b;->K(Ljava/lang/CharSequence;)I
    ...
    :cond_4
    new-instance p5, Lb8/f;

    invoke-direct {p5, p2, p3, v0}, Lb8/f;-><init>(III)V

    :goto_0
    instance-of p2, p0, Ljava/lang/String;

    iget p3, p5, Lb8/f;->a:I

    iget v1, p5, Lb8/f;->c:I

    iget p5, p5, Lb8/f;->b:I
    ...
    invoke-static/range {v2 .. v7}, Le8/f;->C(Ljava/lang/String;IILjava/lang/String;IZ)Z
    ...
    invoke-static/range {v2 .. v7}, Lkotlin/text/b;->W(Ljava/lang/CharSequence;ILjava/lang/CharSequence;IIZ)Z
...
.method public static N(Ljava/lang/CharSequence;CIZI)I
    ...
    invoke-static {p2, p0, p3, p4}, Lkotlin/text/b;->P(ILjava/lang/CharSequence;Z[C)I
...
.method public static synthetic O(Ljava/lang/CharSequence;Ljava/lang/String;IZI)I
    ...
    :cond_1
    invoke-static {p2, p0, p1, p3}, Lkotlin/text/b;->L(ILjava/lang/CharSequence;Ljava/lang/String;Z)I
...
.method public static final P(ILjava/lang/CharSequence;Z[C)I
    ...
    :cond_1
    invoke-static {p1}, Lkotlin/text/b;->K(Ljava/lang/CharSequence;)I
    ...
    invoke-static {v6, v3, p2}, La6/b;->s(CCZ)Z
...
.method public static R(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {v1, p1, v0}, La6/b;->s(CCZ)Z
...
.method public static final T(Ljava/lang/CharSequence;)Ljava/util/List;
    ...
    invoke-static {p0, v0, v1, v1}, Lkotlin/text/b;->V(Ljava/lang/CharSequence;[Ljava/lang/String;ZI)Le8/b;
    ...
    invoke-direct {p0, v0, v1}, Ld8/n;-><init>(Ld8/g;Lw7/l;)V

    invoke-static {p0}, Lkotlin/sequences/a;->r(Ld8/g;)Ljava/util/List;
...
.method public static V(Ljava/lang/CharSequence;[Ljava/lang/String;ZI)Le8/b;
    .locals 2

    invoke-static {p3}, Lkotlin/text/b;->Y(I)V
    ...
    invoke-direct {v0, p0, p1, p3, v1}, Le8/b;-><init>(Ljava/lang/CharSequence;IILw7/p;)V
...
.method public static final W(Ljava/lang/CharSequence;ILjava/lang/CharSequence;IIZ)Z
    ...
    invoke-static {v2, v3, p5}, La6/b;->s(CCZ)Z
...
.method public static final X(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lkotlin/text/b;->c0(Ljava/lang/CharSequence;Ljava/lang/String;)Z
...
.method public static final Z(ILjava/lang/CharSequence;Ljava/lang/String;Z)Ljava/util/List;
    .locals 7

    invoke-static {p0}, Lkotlin/text/b;->Y(I)V

    const/4 v0, 0x0

    invoke-static {v0, p1, p2, p3}, Lkotlin/text/b;->L(ILjava/lang/CharSequence;Ljava/lang/String;Z)I
...
.method public static a0(Ljava/lang/CharSequence;[C)Ljava/util/List;
    .locals 3
    ...
    invoke-static {v2, p0, p1, v2}, Lkotlin/text/b;->Z(ILjava/lang/CharSequence;Ljava/lang/String;Z)Ljava/util/List;
    ...
    :cond_0
    invoke-static {v2}, Lkotlin/text/b;->Y(I)V
    ...
    invoke-direct {v0, p0, v2, v2, v1}, Le8/b;-><init>(Ljava/lang/CharSequence;IILw7/p;)V

    new-instance p1, Ld8/l;

    invoke-direct {p1, v0}, Ld8/l;-><init>(Le8/b;)V
    ...
    invoke-virtual {p1}, Ld8/l;->iterator()Ljava/util/Iterator;
    ...
    invoke-static {p0, v1}, Lkotlin/text/b;->d0(Ljava/lang/CharSequence;Lb8/h;)Ljava/lang/String;
...
.method public static b0(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
    .locals 4
    ...
    invoke-static {v1, p0, v0, v1}, Lkotlin/text/b;->Z(ILjava/lang/CharSequence;Ljava/lang/String;Z)Ljava/util/List;
    ...
    :cond_1
    invoke-static {p0, p1, v1, v1}, Lkotlin/text/b;->V(Ljava/lang/CharSequence;[Ljava/lang/String;ZI)Le8/b;

    move-result-object p1

    new-instance v0, Ld8/l;

    invoke-direct {v0, p1}, Ld8/l;-><init>(Le8/b;)V
    ...
    invoke-virtual {v0}, Ld8/l;->iterator()Ljava/util/Iterator;
...
.method public static c0(Ljava/lang/CharSequence;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1, v0}, Le8/f;->G(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public static final d0(Ljava/lang/CharSequence;Lb8/h;)Ljava/lang/String;
    .locals 1
...
.method public static e0(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v1, v1, v0}, Lkotlin/text/b;->O(Ljava/lang/CharSequence;Ljava/lang/String;IZI)I
...
.method public static final f0(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v2, v0, v1}, Lkotlin/text/b;->R(Ljava/lang/CharSequence;CII)I
