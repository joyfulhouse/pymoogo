...
# direct methods
.method public constructor <init>(Lv4/d$a;II)V
    .locals 2
    ...
    iput-object p1, p0, Lv4/d;->a:Lv4/d$a;
    ...
    invoke-static {p2, p3}, Le1/c;->q(II)Ljava/text/SimpleDateFormat;
...
.method public final a(La5/a;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lv4/d;->b:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lv4/d;->b:Ljava/util/ArrayList;
    ...
    invoke-static {v0, v1}, Lw4/a;->b(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    :goto_0
    iget-object v0, p0, Lv4/d;->a:Lv4/d$a;

    invoke-virtual {v0, p1}, Lv4/d$a;->a(Ljava/util/Date;)Ljava/util/Date;
